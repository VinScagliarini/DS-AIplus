...
- Sostituisce *Montserrat* e *Roboto* dell'Adobe Fonts originale (entrambi
  della stessa famiglia geometrica neutra). Il pacchetto Illustrator
  include anche `MyriadPro-Regular.otf` come fallback.
- CDN: `https://fonts.googleapis.com/css2?family=Roboto:wght@300..700&display=swap`

```css
body {
  font-family: "Roboto", "Myriad Pro", system-ui, sans-serif;
  line-height: 1.65;
}
```
